...
import * as projecttestSuites_suiteIdtestCasesGETHandler from "../backend/router/project/testSuites/_suiteId/testCases/GET";
...
export type ApiRouter = {
    ...
    testCases: {
    GET: ExtractRPCFromHandler<projecttestSuites_suiteIdtestCasesGETHandler.Handle>;
    };
    };
    };
    tms: {
